...
const ViewArticleScreen = () => {
  ...
  useEffect(() => {
    viewArticle(view, teacherInfo?._id);
  }, []);
        ...
        <div className="space-y-4 md:w-[95%]">
          ...
          <div className="flex items-center gap-4 text-black font-semibold">
            <div className="">
              <img
                ...
                alt=""
                className="avatar border rounded-full h-[50px] w-[50px] object-cover"
              />
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div
              ...
              onClick={() => {
                likeArticle(view, teacherInfo?._id).then(() => {
