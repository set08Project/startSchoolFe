            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
              <div className="relative pl-16">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                  Saving you time on paperwork like a magical time wizard. More
                  time for what really matters – shaping young minds.
                </dd>
              </div>
              <div className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                  ...
                  Attendance whisperer
                </dt>
                <dd className="mt-2 text-base leading-7 text-gray-600">
                  No more "Is Chisom in class?" with attendance. Track it, nail
                  it, and get back to the important stuff.
                </dd>
              </div>
              <div className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                  Have the flexible ability to set quizzes, tests, create
                  awesome lesson notes and even CBTs. Evrything made easier 😊
                </dd>
              </div>
              <div className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                  ...
                  Handling classes & assignments
                </dt>
                <dd className="mt-2 text-base leading-7 text-gray-600">
                  It helps plans classes, assign teachers, go through students'
                  submitted assignments on the platform and help everyone know
