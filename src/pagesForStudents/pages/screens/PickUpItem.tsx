    ...
    <div className="text-blue-950">
      <p className="font-medium leading-tight mb-3 text-[12px]">
        {item?.delievered! ? (
          <p>
            ...
            <br />
            <span className="font-bold">Thanks for being patient with us!</span>
          </p>
        ) : (
          <p>
            You'd made this purchase but it hasn't been comfirm... We are still
            on it. <br />
      ...
      <div className="flex items-center flex-wrap gap-5">
        ...
        <div className="font-medium">
          ...
          <div className="text-[12px]  text-[silver] italic">{item?.date}</div>
        </div>
      </div>
