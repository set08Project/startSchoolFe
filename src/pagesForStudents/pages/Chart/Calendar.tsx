  ...
  return (
    <div className="flex flex-col items-center mr-10 mb-12">
      ...
      <div className="w-[80%] text-blue-950  mb-5 flex justify-center items-center gap-2">
        <div className="text-blue-950 font-semibold text-[13px] md:text-[17px]">{currentDay},</div>
        <div className="text-blue-950  font-semibold text-[13px] md:text-[17px]">{currentMonth} 2024</div>
      </div>
          ...
          <div
            ...
            className={`flex items-center justify-center py-2 px-3 rounded-full ${
              day === currentDate.getDate()
                ? "bg-indigo-800 border-[2px]  border-white text-white rounded-[50%] h-[35px] w-[35px]"
                : "bg-white"
            }`}
          >
            {day}
