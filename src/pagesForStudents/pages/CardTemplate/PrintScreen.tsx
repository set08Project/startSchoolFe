...
//                   <div className="flex-1 bg-slate-50 border min-h-10">
...
//                   <p className="my-2 border h-[40px] p-2 mb-5">
//                     {grade?.adminComment}
//                   </p>
//                   <div className="flex w-full">
//                     <div className="flex-1 flex flex-col">
            ...
            <div className="max-w-[1200px] p-4 overflow-hidden border">
              <div
                        ...
                        <div className="hidden md:flex items-center justify-between w-auto">
                          ...
                          {/* school info */}
                          <div className="flex justify-center items-center flex-col">
                            <h1 className="font-bold uppercase text-[25px]">{schoolName}</h1>
                            <h1 className="text-[12px] font-semibold tracking-[0.6rem]">
                              {schoolAddress}
                            </h1>
                          </div>
                                  ...
                                  >
                                    ...
                                    <div className=" w-[78px] border-r flex flex-col justify-center items-center ">
                                      <p className="text-[12px]">
                                        ...
                                        {st1?.result?.find((e) => e.subject === el?.subject)
                                          ?.points||0 +
                                          st2?.result?.find((e) => e.subject === el?.subject)
                                            ?.points||0 +
                                          st3?.result?.find((e) => e.subject === el?.subject)
                                            ?.points||0}
                                      </p>
                                    </div>
                                    {(school?.presentTerm === "1st Term" ||
                          ...
                          <div className="bg-slate-50 overflow-auto h-[100px] flex items-end pb-2 ">
                            {grade?.result?.map((el: any, i: number) => (
                              <ChartPerformance
                                ...
                                key={i}
                                subject={el?.subject}
                                score={el?.test1 + el.test2 + el?.test3 + el.test4 + el.exam}
                              />
                            ))}
                          </div>
                        </main>
