...
const ChartPerformance: FC<any> = ({ subject, score, low, max }) => {
  ...
  console.log("subjectData", schoolInfo);
  // console.log("subjectData", schoolInfo[0]?.year||"");
  // console.log("subjectData", schoolInfo[0]?.presentTerm||"");
  ...
  // let reportData = gradeData?.reportCard?.find((el: any) => {
  //   return (
  //     el.classInfo === `${subjectInfo?.designated} session: 2024/2025(3rd Term)`
  //   );
  // });
