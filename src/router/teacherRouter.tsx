...
const QuizSetupScreen = React.lazy(() => import ("../pagesForTeachers/pages/quiz/QuizSetupScreen"))
...
const Article = React.lazy(() => import("../pagesForTeachers/pages/article/Article"))
