...
const AdminLessonNote = () => {
  ...
  const randomBgColors = () => {
    ...
    const textBg = randomBg.replace("bg", "text");
            ...
            <div className="">
              ...
              <div className="mt-5 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-3 sm:grid-cols-1 ">
                <div
                  ...
                  className="p-5 min-h-[200px] border rounded-[15px] shadow-sm"
                >
                  ...
                  <div className="mb-2 flex items-center font-semibold ">
                    ...
                    <h2 className="">Rasheedat Eromonsele</h2>
                  </div>
                  <div className="mb-2 flex items-center font-semibold ">
                    <h2 className="w-[70px]">For:</h2>
                    <h2 className="">SSS 3COMMERCIAL</h2>
                  </div>
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div>
                      <div className="py-2 px-2 text-[22px] font-extrabold rounded-lg text-white bg-blue-950 cursor-pointer scale-105">
